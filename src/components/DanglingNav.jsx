...
export default function DanglingNav(props) {
  ...
  return (
    ...
    <div className="fixed left-0 top-6 z-50">
      {/* hanging line */}
      <div
...
/>
        ...
        {/* hover menu */}
        <div className="pointer-events-none opacity-0 translate-y-2 group-hover:translate-y-0 group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-300">
          <div
